...
namespace AppKit.TextKit.Formatter
{
	...
	public class SourceTextViewDelegate : NSTextViewDelegate
	{
		...
		/// events instead.
		/// </remarks>
		public override void DraggedCell (NSTextView view, NSTextAttachmentCell cell, CGRect rect, NSEvent theEvent, UIntPtr charIndex)
		{
			// Pass through to Text Editor event
			TextEditor.RaiseSourceCellDragged(TextEditor, new NSTextViewDraggedCellEventArgs(cell, rect, theEvent, charIndex));
		}
