...
namespace KimonoMac
{
	...
	public class AppDelegate : NSApplicationDelegate
	{
		...
		public override NSApplicationTerminateReply ApplicationShouldTerminate(NSApplication sender)
		{
			...
			foreach (NSWindow window in NSApplication.SharedApplication.DangerousWindows.ToArray())
			{
		...
		public void UpdateWindowPreferences()
		{
			...
			for (int n = 0; n < NSApplication.SharedApplication.DangerousWindows.ToArray().Length; ++n)
			{
				var content = NSApplication.SharedApplication.DangerousWindows[n].ContentViewController as ViewController;
				if (content != null)
				{
					// Reformat all text
